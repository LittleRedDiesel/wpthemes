...
/* Updated Columns */
add_shortcode ( "dt_sc_one_half",  "dt_sc_columns" );		add_shortcode ( "dt_sc_one_third",  "dt_sc_columns" );		add_shortcode ( "dt_sc_one_fourth",  "dt_sc_columns" );
add_shortcode ( "dt_sc_one_fifth",  "dt_sc_columns" );		add_shortcode ( "dt_sc_one_sixth",  "dt_sc_columns" );		add_shortcode ( "dt_sc_two_sixth",  "dt_sc_columns" );
add_shortcode ( "dt_sc_two_third",  "dt_sc_columns" );		add_shortcode ( "dt_sc_three_fourth",  "dt_sc_columns");	add_shortcode ( "dt_sc_two_fifth",  "dt_sc_columns" );
add_shortcode ( "dt_sc_three_fifth", "dt_sc_columns" );		add_shortcode ( "dt_sc_four_fifth", "dt_sc_columns" );		add_shortcode ( "dt_sc_three_sixth",  "dt_sc_columns" );
add_shortcode ( "dt_sc_four_sixth",  "dt_sc_columns" );		add_shortcode ( "dt_sc_five_sixth",  "dt_sc_columns" );

add_shortcode ( "dt_sc_one_half_inner",  "dt_sc_columns");		add_shortcode ( "dt_sc_one_third_inner",  "dt_sc_columns");		add_shortcode ( "dt_sc_one_fourth_inner",  "dt_sc_columns");
add_shortcode ( "dt_sc_one_fifth_inner",  "dt_sc_columns" );	add_shortcode ( "dt_sc_one_sixth_inner",  "dt_sc_columns" );	add_shortcode ( "dt_sc_two_sixth_inner",  "dt_sc_columns" );
add_shortcode ( "dt_sc_two_third_inner",  "dt_sc_columns" );	add_shortcode ( "dt_sc_three_fourth_inner",  "dt_sc_columns" );	add_shortcode ( "dt_sc_two_fifth_inner",  "dt_sc_columns" );
add_shortcode ( "dt_sc_three_fifth_inner",  "dt_sc_columns" );	add_shortcode ( "dt_sc_four_four_inner", "dt_sc_columns" );		add_shortcode ( "dt_sc_three_sixth_inner",  "dt_sc_columns" );
add_shortcode ( "dt_sc_four_sixth_inner",  "dt_sc_columns" );	add_shortcode ( "dt_sc_five_sixth_inner",  "dt_sc_columns" );	add_shortcode ( "dt_sc_four_fifth_inner", "dt_sc_columns" );
		
function dt_sc_columns($attrs, $content = null, $shortcodename = "") {
	extract ( shortcode_atts ( array ( 'id' => '', 'class' => '', 'style' => ''  ), $attrs ) );
	...
	$content = my_shortcode_helper($content);
	$out = "<div {$id} class='dt-column {$shortcodename} {$class} {$first}' {$style} >{$content}</div>";
return $out;
}
/* Updated Columns Ended */
