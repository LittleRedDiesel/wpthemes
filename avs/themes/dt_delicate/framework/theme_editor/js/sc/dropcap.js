scnShortcodeMeta = {
	attributes : [

			{
				...
				selectValues : [ 'dropcap-defaul' ,'dropcap-circle' ,'dropcap-bordered-circle','dropcap-square','dropcap-bordered-square'],
				defaultValue : 'dropcap-circle',
				defaultText : 'dropcap-circle'
			},
