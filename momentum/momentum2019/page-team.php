  ...
  <div class="wrap-content container-fluid">
    <section class="row-full row-full--nopadding-right bg-black">
      ...
      <div class="section-content">
    			...
    			<div class="list-item col-md-6 col-xs-12">
    				...
    				<?php
    					...
    					if( !empty($qualifications_list) ): ?>
    						...
    						<a href="" role="button" class="qualifications-trigger lightbox-trigger" data-lightbox="qual-<?php echo $post->ID ?>">View qualifications >></a>
    		...
    		<?php endif; ?>
        <div class="col-xs-12">
    		    <a href="" role="button" class="button button--center button-expand"><?php the_field('team_section_button'); ?></a>
        </div>
